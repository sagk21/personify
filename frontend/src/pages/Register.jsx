        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-semibold text-gray-900 mb-2">
              Your Journey To Powerful<br /><span className="text-brand-pink">Personal</span> Branding Starts Here.
            </h1>
            <p className="text-gray-600">
              Join Thousands Of Creators Using Personify To Elevate Their Personal Brand With Realistic AI Photos.
            </p>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <button
              disabled
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-full hover:bg-gray-50 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <p className="text-center text-gray-600 mt-6">
            ...
            <Link to="/login" className="text-brand-pink hover:text-pink-700 font-semibold">
              Login
            </Link>
          </p>
        </div>
